...
impl CheckTxResult {
  ...
  pub fn with_code(mut self, code: i32) -> CheckTxResult {
    self.code = Some(code);
    self
  }
  ...
  pub fn with_data(mut self, data: String) -> CheckTxResult {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_gas_used(mut self, gas_used: i32) -> CheckTxResult {
    self.gas_used = Some(gas_used);
    self
  }
  ...
  pub fn with_gas_wanted(mut self, gas_wanted: i32) -> CheckTxResult {
    self.gas_wanted = Some(gas_wanted);
    self
  }
  ...
  pub fn with_info(mut self, info: String) -> CheckTxResult {
    self.info = Some(info);
    self
  }
  ...
  pub fn with_log(mut self, log: String) -> CheckTxResult {
    self.log = Some(log);
    self
  }
  ...
  pub fn with_tags(mut self, tags: Vec<::models::KvPair>) -> CheckTxResult {
    self.tags = Some(tags);
    self
  }
